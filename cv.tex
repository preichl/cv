...
}{C|Git|Fedora|Python|BASH|LDAP|Kerberos|PAM|Autotools, Github|Unit Testing}
\subtopic{Projects}{\faFolderO}
\project{
  \emph{SSSD} is a system daemon. Its primary function is to provide access to identity and authentication of remote resources.}
\project{
